 ...
 * File: user.h
 * File Description: Includes the user-mode function declarations that will trigger the actual
 *                   syscall in kernel-mode.
 * Changes: Added cps104() function declaration in the `system calls` section
 */
